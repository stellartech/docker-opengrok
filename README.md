...
```sh
docker run -d -v [source to be indexed on host]:/src -p [public port]:8080 stellartechnologies/docker-opengrok 
```
...
This fork does not allow vcs history to be indexed and used.
